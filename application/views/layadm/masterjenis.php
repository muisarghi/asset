...
<th scope='col'>Penyusutan<br>(Tahun)</th>
<th scope='col'>Penyusutan<br>(Persen)</th>
<th scope='col'>Keterangan</th>
<th scope='col' colspan='2'>Act</th>
</tr>

<tr>
<form method='post' action='".base_url()."index.php/mda/inputjns'>
<th scope='col'></th>
<th scope='col'>
<input type='text' name='nmjenis' class='input-sm form-control-sm form-control'>
</th>
<th scope='col'>
...
foreach($gol as $a)
	{
	echo"
	<option value='$a->idgol'>$a->namagol</option>
	";
	}
echo"
</select>
</th>
<th scope='col'><input type='text' name='kodejenis' class='input-sm form-control-sm form-control'></th>
<th scope='col'><input type='text' name='thnsusut' class='input-sm form-control-sm form-control'></th>
<th scope='col'><input type='text' name='persensusut' class='input-sm form-control-sm form-control'></th>
<th scope='col'><input type='text' name='ketjenis' class='input-sm form-control-sm form-control'></th>
