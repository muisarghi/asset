		...
		<div class="content mt-3">
            ...
            <div class="col-sm-12">
				...
				<div class="card">
					...
					<strong>Data Barang<i><b><?php echo" $nmjenis"; ?></b></i></strong>
					...
					foreach($brg as $c)
						...
						<td>$c->tglbeli</td>
						<td>$c->hargabeli</td>"; ?>
						<td><a href='#' data-target='#editmbarangj' data-toggle='modal' data-id="<?php echo"$c->idbarang"; ?>"><i class='fa fa-edit'></i></a>	</td>
						<td><a 
                        href="javascript:;"
						data-idgol=""
						data-namagol=""
			 ...
			 <div class="modal fade" id="tmbbrg" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<td><?php
						echo"
						<input type='hidden' name='idjenis' value='$idjenis' class='form-control'>
						<input type='text' name='nmjenis' value='$nmjenis' class='form-control' disabled>
						";
						?>
						</td>
						</tr>
			...
			"; ?>
			 ...
			 <div class="modal fade" id="editmbarangj" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#editmbarangj').on('show.bs.modal', function (e) {
            var rowid = $(e.relatedTarget).data('id');
            //menggunakan fungsi ajax untuk pengambilan data
            $.ajax({
                type : "post",
				url : '<?php echo base_url(); ?>index.php/kl/detailbarangj',
				data :  "rowid="+ rowid,
